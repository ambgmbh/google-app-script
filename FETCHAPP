// Importieren der Bibliothek UrlFetchApp
var urlFetch = UrlFetchApp;
...
// Funktion zum Erstellen einer neuen Tabelle für ein bestimmtes Jahr
function createTableForYear(year) {
  // Abrufen der Daten aus der Tabelle "sunny" für das Jahr 2024
  var sunnyData = SpreadsheetApp.openById("TABLE_ID").getSheetByName("sunny").getDataRange().getValues();
